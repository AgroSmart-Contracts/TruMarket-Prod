...
/** @deprecated legacy DB typo */
export const LEGACY_TRANSPORT_BY_SEA = "sea_fright";

export function isSeaTransport(transport?: string): boolean {
  return transport === ITransportType.BY_SEA || transport === LEGACY_TRANSPORT_BY_SEA;
}

export function isAirTransport(transport?: string): boolean {
  return transport === ITransportType.BY_AIR;
}
