      ...
      <Fade in={open}>
        <div
          className={classNames(
            ...
            classOverrides,
            fullScreen ? "h-full w-[90vw]" : "h-auto w-full max-w-[400px] max-h-[85vh] flex flex-col overflow-hidden",
          )}
        >
          <div className="relative flex min-h-0 w-full max-w-full flex-col">
            ...
            <div
              className={classNames(
                ...
                fullScreen ? "flex min-h-0 flex-1 flex-col" : "max-h-[calc(85vh-4.5rem)]",
              )}
            >
              {children}
            </div>
