      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        ...
        >
          <button
            ...
            className="rounded-xl border border-[#E5E7EB] bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 hover:border-[#E5E7EB] hover:bg-slate-50 md:w-auto disabled:cursor-not-allowed disabled:opacity-50"
          >
