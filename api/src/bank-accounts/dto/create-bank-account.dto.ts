...
export class CreateBankAccountDto {
  ...
  @ApiProperty({ required: false, description: 'If creating an update request for an existing account' })
  @Expose()
  @IsOptional()
  @IsString()
  supersedesId?: string;
  ...
  @ApiProperty({ description: 'Plain account number; will be encrypted server-side' })
  @Expose()
  @IsString()
  @IsNotEmpty()
