  ...
  paymentDocuments: [
    {
      ...
      reusedFromDeal: { type: Boolean, required: false, default: false },
      verifiedByAdmin: { type: Boolean, required: false, default: false },
      verifiedAt: { type: Date, required: false },
      documentUploadMode: { type: String, required: false },
      tradePdfClassification: { type: Schema.Types.Mixed, required: false },
      peruDrawbackClassification: { type: Schema.Types.Mixed, required: false },
    },
  ],
