...
BankAccountSchema.index({ provider: 1, providerAccountId: 1 }, { unique: true });
...
BankAccountSchema.index(
  { userId: 1, provider: 1, isDefault: 1 },
  { unique: true, partialFilterExpression: { isDefault: true, archived: false } } as any,
);
