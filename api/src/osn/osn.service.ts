...
import {
  ...
  OsnOrganizationBankCreateResult,
...
export class OsnService {
  ...
  async createOrganizationBankAccount(input: {
    ...
    const payload: OsnOrganizationBankCreateRequest =
      mapBankAccountCreateToOsnPayload({
  ...
  async listOrganizationBanks(options?: {
    ...
    const response = await this.client.get<OsnOrganizationBank[]>(
      '/users/me/organization-banks',
      query,
    );
    return response;
  ...
  async listOrganizationWallets(): Promise<
    { wallets: OsnOrganizationWallet[] } | OsnOrganizationWallet[]
  > {
    const response = await this.client.get<any>(
      '/users/me/wallets/organization',
    );
    return response;
  }
  ...
  async getPaymentHistoryStatus(
    paymentId: string,
  ): Promise<OsnPaymentHistoryStatusResponse> {
  ...
  async vetSettlementRequest(input: {
    ...
    const response =
      await this.client.post<OsnMintVetSettlementRequestResponse>(
